...
<div id="airport" class="tabcontent-car" style="display:block">
   ...
   <input type="hidden" name="rent_type" value="36" id="daily_rent_type" />
    ...
    <div class="form-group col-md-12 col-lg-3">
            <input type="text" class="car-date" name="daily[pickup_date]" id="daily_pickup_date" placeholder="Pick Up Date" value="<?php echo date("m/d/Y");?>">
            <input type="text" class="car-date" id="daily_dropoff_date" name="daily[dropoff_date]" placeholder="Drop Off Date" value="<?php echo date("m/d/Y");?>">
    </div>
    <div class="form-group col-md-12 col-lg-3">
	...
	<form class="form-inline" action="https://www.sonicstartravel.com/car_rental/cars" method="post" id="frm_daily">
        ...
        <select name="car_city" id="car_city_daily" class="select2class">
          ...
          <?php } ?>
			...
			<div class="form-group col-md-12 col-lg-3">
	        <input type="text" class="car-date" name="daily[pickup_date]" id="daily_pickup_date1" placeholder="Pick Up Date" value="<?php echo date("m/d/Y");?>">
	    </div>
	    <div class="form-group col-md-12 col-lg-3">
	        <input type="text" class="car-date" id="daily_dropoff_date1" name="daily[dropoff_date]" placeholder="Drop Off Date" value="<?php echo date("m/d/Y");?>">
      </div>
			<div class="container">
        <br>
				<button type="submit" id="onewaysubmit" class="btn-search float-right">Search</button>
